...
class NewsRepository {
  ...
  Future<CategoriesNewsModel> fetchNewsCategoires(String category) async {
    String newsUrl =
        "https://newsapi.org/v2/everything?q=$category&sortBy=popularity&apiKey=b47974507a0246558da739f7e13e9229";
  ...
  Future<NewsChannelsHeadlinesModel> fetchNewsChannelHeadlinesApi(String newsChannel) async {
    String newsUrl = 'https://newsapi.org/v2/everything?sources=${newsChannel}&sortBy=popularity&language=en&apiKey=b47974507a0246558da739f7e13e9229';
    print(newsUrl);
    final response = await http.get(Uri.parse(newsUrl));
